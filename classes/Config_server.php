...
$GLOBALS['configuration'] = array(
	'mysql' => array(
		'host' => '67.225.140.132',
		'db_name' => 'hikmahsc_db',
		'db_password' => '1905871231657939Ab',
		'db_username' => 'hikmahsc_user'
	),
	'cookie' => array(
		'table' => 'users_cookie',
		'table0' => 'mgt_cookie',
		...
		'secure' => true,    //sets if cookies can only be transmitted by https requests
	...
	'webmail' => [
		...
		'password' => "hikmahSCHOOLS001", // SMTP account password
		'name' => 'Hikmah Group Of Schools'
	],
	'server' => array(
		'name' => 'https://' . Utility::escape($_SERVER['HTTP_HOST']) . '/',
		'protocol' => 'https://'
	),
	'error' => array(
