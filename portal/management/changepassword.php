<?php
    ...
    if(Input::submitted() && Token::check(Input::get('token'))){
        ...
        if($val->check($values)){
           if($mgt->conf_pwd(Input::get('old_pwd'))){
               $mgt->changePassword(Input::get('new_pwd'));
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Utility::escape($url->to('styles/changepassword.css',1))?>" />
</head>
