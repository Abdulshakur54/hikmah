...
<div class="grid-margin stretch-card">
    <div class="card">
                ...
                <table class="table table-hover display" id="messagingTable">
                    ...
                    <tbody>
                        ...
                        if (!empty($subordinates)) {
                            ...
                            <td>
                                <input type="checkbox" class="checkbox" value="' . $sb->staff_id . '" checked />
                            </td>
                         </tr>';
                            }
                        } else {
        ...
        <input type="hidden" value="staff" name="userTable" id="userTable" />
    ...
    <script>
        ...
        function changeSchool(){
            ...
            getPage('management/hrm/send_message.php?school='+school+'&token='+_('token').value);
        }
