...
<body>
    <main>
        ...
        <form method="post" action = "<?php echo Utility::myself() ?>" onsubmit="return addToken();">
            <div class="formhead">Generate Admission Tokens</div>
            <div>
            ...
            <div>
                ...
                <div>
                    <select name="level" id="level">
                        <?php 
                        $levels = School::getLevels('HCK');//HCK is used as the default school
                        $genHtml = '';
                        foreach($levels as $lvlName=>$lvl){
                            $genHtml.='<option value="'.$lvl.'">'.$lvlName.'</option>';
                        }
                        echo $genHtml;
                        ?>
                    </select>
