...
<script>
    function submitClass() {
        ...
        getPage('management/apm/performance_summary.php?class_id=' + cls + '&school=' + school + '&token=' +
            _('token').value);
    }
    ...
    function changeClass() {
        ...
        let school = _('school').value
        if (term.length > 0) {
            getPage('management/apm/performance_summary.php?class_id=' + cls + '&term=' + term + '&school=' + school + '&token=' +
                _('token').value);
        }
