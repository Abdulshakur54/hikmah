...
<script>
    function submitClass() {
        ...
        getPage('management/director/performance_chart.php?class_id=' + cls +
            '&school=' + school +
            '&token=' +
            _('token').value);
    }
    ...
    function changeClass() {
        ...
        let school = _('school').value;
        if (term.length > 0) {
            getPage('management/director/performance_chart.php?class_id=' + cls + '&term=' + term + '&school=' + school +
                '&token=' +
                _('token').value);
        }
    ...
    function viewPerformance(term) {
        let cls = _('class').value;
        let school = _('school').value
        getPage('management/director/performance_chart.php?class_id=' + cls + '&school=' + school + '&term=' + term +
            '&token=' +
            _('token').value);
    }
