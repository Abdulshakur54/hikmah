<?php
	...
	//end of initializations
        ...
        if(Input::submitted() && Token::check(Input::get('token'))){
           ...
           /*The commented code above is the right code but replace specifically for this project with the one below*/
           $table = 'student2';
           ...
           if($db->one_result()->counter > 0){
                ...
                $link = $url->to('reset_password.php',3).'?selector='.$selector.'&resetToken='.$resetToken;
                ...
                if($mail->send($email, 'Reset Password Link', $message)){
                    ...
                    Redirect::home('success.php?recoverPassword=true',3);
                }else{
