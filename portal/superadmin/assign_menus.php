...
<div class="grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title text-primary">Assign Menus</h4>
            ...
            <div class="table-responsive">
                ...
                <div class="text-center mt-2">
                    <button type="button" class="btn btn-primary mr-2" id="addBtn" onclick="addMenuToRole()">Add Selected Menus</button><span id="ld_loader_add"></span>
                </div>
            </div>
        </div>
...
<script src="scripts/superadmin/assign_menus.js">